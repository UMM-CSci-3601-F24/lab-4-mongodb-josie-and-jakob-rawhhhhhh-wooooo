...
describe('AddTodoComponent', () => {
  ...
  describe('The owner field', () => {
    ...
    it('should be fine with "Cramba Slamba"', () => {
      ownerControl.setValue('Cramba Slamba');
      expect(ownerControl.valid).toBeTruthy();
    });

    it('should not pass on single character owners', () => {
      ownerControl.setValue('x');
      expect(ownerControl.valid).toBeFalse();
    });
...
describe('AddTodoComponent#submitForm()', () => {
  ...
  beforeEach(() => {
    component.addTodoForm.controls.owner.setValue('Jofer');
    component.addTodoForm.controls.category.setValue('software design');
    component.addTodoForm.controls.body.setValue('Finish Lab 4');
  });
